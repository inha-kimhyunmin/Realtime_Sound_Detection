...
# --- 모델 경로 설정 ---
MODEL_PATH = 'model_results_v1.33/yamnet_lstm_model_v1.33.h5'  # 기본 모델 경로
...
ANALYSIS_WAIT_TIME = 3.0    # 분석 완료 후 다음 녹음까지 대기 시간 (초)
